...
namespace PaintIn3D
{
	...
	public class P3dSpawner : MonoBehaviour, IHit, IHitPoint
	{
		...
		/// <summary>The spawned prefab will be offset from the hit point based on the hit normal by this distance in world space.</summary>
...
namespace PaintIn3D
{
	...
	public class P3dSpawner_Editor : P3dEditor<P3dSpawner>
	{
		protected override void OnInspector()
		{
			...
			EndError();
			Draw("offset", "The spawned prefab will be offset from the hit point based on the hit normal by this distance in world space.");
